        ...
        <div id="modalContentTambahUB"
            ...
            <form id="formTambahUB" action="{{ route('ub.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-2">Nama Unit Bisnis <span
                                    class="text-red-500 font-normal italic">*harap diisi</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 mb-2">Deskripsi <span
                                    class="text-red-500 font-normal italic">*harap diisi</span></label>
                    ...
                    {{-- Link Website & Medsos --}}
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-2">Link Website <span
                                class="text-red-500 font-normal italic">*harap diisi</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-700 mb-2">Link Media Sosial <span
                                class="text-red-500 font-normal italic">*harap diisi</span></label>
                        <input type="url" name="link_ig_ub" placeholder="Contoh: https://instagram.com/user"
                            required
                            class="w-full px-4 py-3 text-xs border border-dashed border-gray-400 rounded-lg focus:outline-none focus:ring-1 focus:ring-birua transition">
                    </div>
