                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-full max-w-md">
                                ...
                                <div
                                    ...
                                    <img :src="fotoPreview" class="max-w-[80%] max-h-[80%] object-contain rounded-lg">
                                </div>
                                ...
                                <label class="block cursor-pointer">
                                    ...
                                    ">
                                    <div
                                        class="bg-birue text-white font-bold py-3 px-6 rounded-xl text-xs text-center shadow-lg hover:bg-opacity-90 transition duration-150 uppercase tracking-widest">
                                        Unggah Foto/Logo
                                    </div>
                                </label>
                            </div>
